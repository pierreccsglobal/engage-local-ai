  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-4 bg-gradient-to-br from-black via-zinc-900 to-black">
      ...
      <div className="relative z-10 max-w-6xl mx-auto text-center">
        ...
        {/* Boutons d'action avec animations automatiques */}
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
          ...
          <button 
            onClick={openChatbot}
            className="border-2 border-gold-400 text-gold-400 px-8 py-4 rounded-full font-semibold text-lg hover:bg-gold-400 hover:text-black hover:scale-105 hover:shadow-lg hover:shadow-gold-400/25 transition-all duration-300 backdrop-blur-sm focus:outline-none focus:ring-2 focus:ring-gold-600 animate-bounce"
          >
            Voir une Démo
          </button>
        </div>
